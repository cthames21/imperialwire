	...
	<body>
		...
		<div class="page-container">
			<header>
				...
				<div class="imperialwire">
					<div class="toggle" id="imperial">
						Imperial Wire
					</div>
				</div>
				...
				<g class="menuicon">
					...
					<div class="menucontainer">
						<a id="menuoption1" href="home.html">Home</a>
						<a id="menuoption2" href="services.html">Solutions</a>
						<a id="menuoption3" href="howitworks.html">How it Works</a>
			...
			<!--
			<div class="title">
				<img src="photos/headerbackground.jpg">
				<div class="titletext">
			...
			<script>
				...
				$(document).ready(function() {
					$('.menuicon').mouseover(function() {
						$('#hamburgermenu').css("fill","crimson");
