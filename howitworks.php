...
<html>
	...
	<body>
		...
		<div class=”page-container”>
			...
			<div class="drawing">
				<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"width="563.066px" height="563.066px" viewBox="0 0 563.066 563.066" style="enable-background:new 0 0 563.066 563.066;" xml:space="preserve">
					<g>
						<g>
							<path class="path" fill="transparent" stroke="#000000" stroke-width="4" stroke-miterlimit="10"   d="M451.67,363.156c-11.016-37.332-33.048-73.745-50.184-108.63c-1.225-2.448-4.59-3.672-7.344-3.06
							...
							<path class="path" fill="transparent" stroke="#000000" stroke-width="4" stroke-miterlimit="10"  d="M552.344,407.833c-0.918-2.143-4.283-2.754-6.12-1.53c-10.403,7.038-15.911,16.524-20.502,27.846
								...
								/>
							<path class="path" fill="transparent" stroke="#000000" stroke-width="4" stroke-miterlimit="10"   d="M246.956,390.085c-19.584,5.813-41.922,4.283-60.894,11.016c-3.978,1.224-4.284,7.038,0,8.262
								...
								/>
							<path class="path" fill="transparent" stroke="#000000" stroke-width="4" stroke-miterlimit="10"   d="M402.404,395.287c-25.704-4.896-51.408-9.792-77.725-10.099c-2.447,0-4.59,2.143-4.59,4.59
			...
			<div class="process">
				...
				<div class="steps">
					<div id="step1left">
						...
						<div class="details">
							We meet with our soifjaoushgwg
						</div>
					</div>
					<div id="step1right">
						<div class="image">
					...
					<div id="step2left">
						<div class="image">
							<img src="photos/manufacturing.jpeg">
						</div>
					</div>
					<div id="step2right">
						<div class="number">
		...
		<script>
			...
			$(window).on("scroll touchmove", function() {
				...
				$('#step2left').toggleClass("slide", $(document).scrollTop() > 350);
				...
				$('#step4left').toggleClass("slide", $(document).scrollTop() > 950);
				$('#step4right').toggleClass("slide", $(document).scrollTop() > 950);
			});
			...
			$(document).ready(function() {
				...
				$('.righthand').toggleClass("post");
				$('.lefthand').toggleClass("post");
